            ...
            <div id="makemarker-screen">
              ...
              <div id="marker-contents">
                {DefaultAROption.map(i => (
                  ...
                  <img className="marker" id={i} src={process.env.PUBLIC_URL + "/testsrc/defaultAR/"+i+".png"} with="200" height="200" style={checkDefaultARmakerstyle(i)}/> 
                  </label>
                  ))
                }
              </div>
              <div id="buttons">
                <Button variant="contained" onClick={CreateARMaeker} id="next">
                  <a>決定して次へ</a>
                </Button>
